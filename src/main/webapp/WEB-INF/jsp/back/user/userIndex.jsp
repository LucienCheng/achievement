	...
	$(function() {
		...
		$("#pagecount ul li a").bind(
				...
				function() {
					...
					var u = "/achievement/back/user/" + rel + "?achName="
							+ achName + "&achStartTime=" + achStartTime
							+ "&achEndTime=" + achEndTime+"&achStatus="+achStatus;
					if (rel != undefined) {
						window.open(u, "_self");
	...
	function deleteUser() {
		$.ajax({
			...
			success : function(data, statue) {
				window.open("/achievement/back/user?achStatus="+'${condition.achStatus}', "_self");
			}
		});
	}
	function getUrl(){
				...
				<div class="row-fluid ">
					<div class="collapse in" id="collapseExample">
						<div
							...
							<form class="input-group pull-left block-content" action="/achievement/back/user/1">
								...
								<input type="hidden" value='${condition.achStatus}' name="achStatus">
								<script type="text/javascript">
