      ...
      <div class="row-fluid">
        <div class="span2" id="sidebar">
          <ul class="nav nav-list bs-docs-sidenav nav-collapse collapse">
            <li class="active">
              <a href="#">待审核  <span class="badge badge-important  pull-right">17</span></a>
			   
            </li>
            <li>
              <a href="#">审核通过  <span class="badge  pull-right">17</span></a>
            </li>
            <li>
              <a href="#">审核未通过  <span class="badge badge-important  pull-right">17</span></a>
            </li>
          </ul>
        </div>
        <!--/span-->
        <div class="span10" id="content">
		  ...
		  <button class="btn  " type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="true"
          aria-controls="collapseExample">检索条件<span class="caret pull-right"></span></button> 
		  </div>
          <div class="row-fluid ">
...
这里是待审核已通过，未通过，已经待编辑的地方。如果修改模块的话，需要点击保存后才能变成待审核的状态，
否则就是待编辑状态。只要修改了模块保存了，那就是变成戴编辑状态了。如果只是修改成果的信息，那就直接为待审核状态。
  </body>
</html>
