...
if(${curPage}==1)
											...
											s+="<li ><a  href='javascript:void(0)'rel="+(${curPage}-1)+">上一页</a></li>";
											}
										...
										if(${curPage}>=${totalPage})
											...
											s+="<li ><a  href='javascript:void(0)'rel="+(${curPage}+1)+">下一页</a></li>";
											}
											
s+="</ul>";
$("#pagecount").html(s);

$("#pagecount ul li a").bind('click', function() {

			var rel = $(this).attr("rel");
			var userWorkNum='${userCondition.userWorkNum}';
			var userName='${userCondition.userName}';
			var u="/achievement/back/admin/"+rel+"?userWorkNum="+userWorkNum+"&userName="+userName;
		if(rel!=undefined){
			window.open(u,"_self");
...
<div class="modal fade " id="add" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="position:relative;">
